...
def test_render_evolution_success(mock_streamlit, mock_plotly):
    ...
    with patch('infrastructure.ui.components.charts_component.calculate_average_trend') as mock_avg, \
         patch('infrastructure.ui.components.charts_component.calculate_sentiment_distribution_trend') as mock_dist, \
         patch('infrastructure.ui.components.charts_component.calculate_trend_change') as mock_change:
