...
def test_delete_confirmation_execution_success(mock_controller, mock_streamlit):
    ...
    mock_controller.handle_delete_multiple_analyses.return_value = (
        True, [("analisis_1", True, "Deleted")])

    # We need to simulate the "Confirm" button being clicked inside _show_confirmation_ui
    # The render triggers _render_delete_confirmation -> _show_confirmation_ui
    # -> button("Confirmar")
