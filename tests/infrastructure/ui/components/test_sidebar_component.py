...
def mock_components():
    with patch(
        'infrastructure.ui.components.sidebar_component.FileUploadComponent'
    ) as file_upload, patch(
        'infrastructure.ui.components.sidebar_component.DeleteAnalysisComponent'
    ) as delete_analysis, patch(
        'infrastructure.ui.constants.ALL_ANALYSES_OPTION', "Todas"
    ):
