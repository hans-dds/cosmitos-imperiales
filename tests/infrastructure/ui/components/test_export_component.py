...
@pytest.fixture
def mock_exporters():
    with patch('infrastructure.ui.components.export_component.generate_excel_export') as excel_mock, \
         patch('infrastructure.ui.components.export_component.generate_pdf_export') as pdf_mock, \
         patch('infrastructure.ui.components.export_component.apply_comments_filters') as filter_mock:
...
def test_render_downloads_triggered(mock_controller, mock_streamlit, mock_exporters, mock_report_history):
