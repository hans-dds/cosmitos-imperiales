...
class Settings:
    ...
    DB_PASSWORD: str = os.getenv("DB_PASSWORD", os.getenv("MYSQL_PASSWORD", "password"))
    # docker-compose uses DB_DATABASE; also accept DB_NAME
    DB_NAME: str = os.getenv("DB_NAME", os.getenv("DB_DATABASE", os.getenv("MYSQL_DATABASE", "cosmitos_imperiales_db")))
