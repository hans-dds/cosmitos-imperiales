    ...
    def execute(
        ...
        if "Clasificacion" not in original_df.columns:
            return (
                False,
                "",
                "El DataFrame no tiene la columna 'Clasificacion'.",
            )
        ...
        try:
            for index, new_label in modifications:
                ...
                if index not in modified_df.index:
                    return (
                        False,
                        "",
                        f"Índice {index} no existe en el DataFrame.",
                    )
                ...
                try:
                    ...
                    return (
                        False,
                        "",
                        f"Etiqueta inválida '{new_label}': {str(e)}",
                    )
            ...
            return (
                False,
                "",
                f"Error al aplicar modificaciones: {str(e)}",
            )
