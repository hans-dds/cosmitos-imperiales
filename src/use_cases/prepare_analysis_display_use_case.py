...
class PrepareAnalysisDisplayUseCase:
    ...
    def execute(self, df: pd.DataFrame) -> Tuple[pd.DataFrame, Dict[str, str]]:
        """
        Prepara un DataFrame para visualización agregando columnas necesarias
        y retornando el mapa de colores.
