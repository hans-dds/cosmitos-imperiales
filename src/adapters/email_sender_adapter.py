...
class SmtpEmailSender:
    ...
    def __init__(self, smtp_server: str, smtp_port: int, smtp_user: str, smtp_password: str, email_from: str):
    ...
    def send_email(self, to_emails: List[str], subject: str, body: str, attachment_path: Optional[str] = None) -> bool:
        """
        ...
        if attachment_path:
            try:
                ...
                with open(attachment_path, "rb") as f:
                    ...
                    part.replace_header('Content-Type', f'{content_type}; name="{os.path.basename(attachment_path)}"')
                
                # After the file is closed
                part['Content-Disposition'] = f'attachment; filename="{os.path.basename(attachment_path)}"'
                msg.attach(part)
            except Exception as e:
                logger.error(f"Error al adjuntar archivo {attachment_path}: {e}")
                return False
