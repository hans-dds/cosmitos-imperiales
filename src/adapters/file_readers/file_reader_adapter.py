...
class PandasFileReader(IFileReader):
    ...
    def __init__(self, required_sheets: List[str] = None):
        ...
        Args:
            required_sheets: Lista de nombres de hojas requeridas para
            archivos Excel.
                            Si es None, usa las hojas por defecto
                            ["ATC", "Encuesta salida"].
        """
    ...
    def read_file(self, file_object, file_type: str) -> pd.DataFrame:
        ...
        Raises:
            ValueError: Si el tipo de archivo no es soportado o hay un
            error al leerlo.
        """
    ...
    def _read_excel(self, file_object) -> pd.DataFrame:
        """
        Lee un archivo Excel y combina las hojas requeridas en un solo
        DataFrame.
        """
        try:
